...
import 'package:eyflutter_gen/annotations/entity.dart';
import 'package:eyflutter_gen/beans/field_describe.dart';
...
class DbSchemaGenerator extends GeneratorForAnnotation<Entity> {
  ...
  void _genMap(StringBuffer buffer, List<FieldElement> fields, String className) {
    ...
    buffer.writeln("    Map<String, dynamic> map = HashMap<String, dynamic>();");
    for (var element in fields) {
